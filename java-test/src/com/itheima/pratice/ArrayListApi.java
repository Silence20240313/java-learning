...
public class ArrayListApi {
    public static void main(String[] args) {
        ...
        System.out.println(list.remove(1));// MYSQL remove：根据索引删除元素
        System.out.println(list);// [黑马, 黑马, Java]

        // TODO 6.直接删除某个元素值，删除成功会返回true,反之返回false
        System.out.println(list.remove("Java"));// true remove：直接删除某个元素
        ...
        System.out.println(list.set(1, "黑马程序员"));// 黑马   set:修改某个索引位置处的值
