...
public class API2 {
    ...
    //  ①绝对值:-50 100    ②向上取整:5.3 5  ③向下取整:5.3 5
    //  ④四舍五入：4.4 4.5  ⑤最大值：10，20  ⑥最小值： 10，20
    ...
    //    BigDecimal:解决小数运算失真的问题
        ...
        System.out.println(a1.add(b1));// 0.3 加
        System.out.println(a1.subtract(b1));// -0.1 减
        System.out.println(a1.multiply(b1));// 0.02 乘
        System.out.println(a1.divide(b1));// 0.5 除
